...
namespace TicketToRide
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Create the players
            var player1 = new Player("Player1", PlayerColor.Red, board);
            var player2 = new Player("Player2", PlayerColor.Blue, board);
            var player3 = new Player("Player3", PlayerColor.Green, board);
            var player4 = new Player("Player4", PlayerColor.Yellow, board);
            ...
            //Now that each player has calculated their desired routes and colors, output that information to the command line
            player1.OutputPlayerSummary();
            player2.OutputPlayerSummary();
            player3.OutputPlayerSummary();
            player4.OutputPlayerSummary();

            var remainingTurns = -1;
            var inFinalTurn = false;
